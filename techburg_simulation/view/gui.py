# gui.py: If you plan to have a graphical user interface, start developing this file after the core logic is in
# place. This will allow you to visualize the simulation and interact with it.
